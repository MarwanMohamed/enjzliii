...
<section class="s_protfolio single_users_new">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <form id="handleAddProject" action="/handleAddProject" method="post">
                @include('freelancer.privateUser')
                        ...
                        <div class="item_protfolio">
                            <div class="row">
                                <div class="col-md-9 col-sm-8">
                                    <h2>عنوان المشروع</h2>
                                    <input type="text" name="title" required minlength="10">
                                </div>
                                ...
                                <div class="col-md-3 col-sm-4">
                                    ...
                                    <div class="selects2">
                                        <div class="dropdown rd_bgw">
                                          <button class="btn dropdown-toggle" type="button" data-toggle="dropdown">{{sizeof($projectbudget)?('$'.$projectbudget[0]->min.'-$'.$projectbudget[0]->max):''}}
                            ...
                            <h2>وصف مشروع</h2>
                            <textarea rows="6" required name="description"></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                  <div class="all_widas">
                                    ...
                                    <div class="plus_input">
                                        ...
                                        <input type="number" name="deliveryDuration" required class="input-number project-day" value="1" min="1">
                                ...
                                <div class="col-md-12">
                                    <div class="plus_input_drag">
                                        <h2 style="margin-top: 30px;">صور مرفقة (توضيحية)</h2>
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        if (!data.status) {
                            ...
                            nofication_good('تم اضافة المشروع');
                            window.location='/myProjects';
                            setTimeout(function () {
                                window.href.replace('/myProjects');
                            }, 3000);
                        }
                    },
