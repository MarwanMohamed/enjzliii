...
<table border="0" cellpadding="0" cellspacing="0" class="body"
    ...
    <tr>
        ...
        <td class="container"
            style="font-family: tahoma, sans-serif; font-size: 14px; vertical-align: top; Margin: 0 auto !important; max-width: 89%; padding: 10px; width: 89%;"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" class="alert alert-danger"
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        valign="top" bgcolor="#fff"> {{$problem or $title}} </td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="font-family: tahoma, sans-serif; font-size: 14px; vertical-align: top;"
                                            ...
                                            <p style="font-family: tahoma, sans-serif; font-size: 14px; font-weight: normal; Margin: 0; Margin-bottom: 15px;">{!! $msg !!}</p>
                                            @if(isset($urlTo))<p><a href="{{$urlTo}}">لمزيد من المعلومات اضغط هنا</a>
                                            </p>@endif
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="font-family: tahoma, sans-serif; font-size: 14px; vertical-align: top;"
                                            valign="top">
                                            @if(!isset($msg))
                                                <p style="font-family: tahoma, sans-serif; font-size: 14px; font-weight: normal; Margin: 0; Margin-bottom: 15px;"> {!! $welcome !!}</p>
                                                <p style="font-family: tahoma, sans-serif; font-size: 14px; font-weight: normal; Margin: 0; Margin-bottom: 15px;"> {!! $welcomeDesc !!}</p>
                                            ...
                                            @endif
                                            <br>
                                            <p style=" text-align: center;font-family: tahoma, sans-serif; font-size: 14px; font-weight: normal; Margin: 0; Margin-bottom: 15px;">{!! $link !!}</p>
                                            @if(isset($urlTo))<p><a href="{{$urlTo}}">لمزيد من المعلومات اضغط هنا</a>
                                            </p>@endif
                                        </td>
                                    </tr>
