...
@endif
<form class="form-inline " action="/admin/reports/users">

    <div class="form-group">
        <input type="text" class="form-control" value="{{($q)?$q:''}}" name="q" id="exampleInputName2" placeholder="بحث في التبليغات ">
    </div>
       <div class="form-group">
...
<tbody>
    ...
    <tr>
        ...
        <td> 
            @if(checkPerm('show'))<a href="/admin/reports/show/2/{{$project->id}}" title="عرض" class=" btn btn-success btn-xs"><span class="fa fa-arrows-alt"></span></a>
          @endif
        </td>
    </tr>
    @endforeach
