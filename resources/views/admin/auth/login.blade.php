        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="signin-info" >
                    <div class="logopanel">
                        <h1 style="text-align: center ;padding-bottom: 20px"> انجزلي </h1>
                    </div><!-- logo/panel -->
            ...
            <div class="col-md-12">
                ...
                {!! Form::open(['url' => route('handel_login'), 'class' => '']) !!}
                    <h4 class="nomargin">سجل الدخول</h4>
                    ...
                    <input type="password" name="password" class="form-control pword" placeholder="كلمة المرور" />
                    {{ csrf_field() }}
                    <a href="{!! route('forget') !!}"><small>نسيت كلمة المرور؟</small></a>
