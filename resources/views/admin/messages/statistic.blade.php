          ...
          <div class="panel-heading">
            ...
            <div class="panel-body">
              <ul>
                ...
                <li>
                  <a href='/admin/messages/single/{{$value->id}}'>
                  <small class="pull-right">{{dateToString($value->created_at)}}</small>
                  <h4 class="sender">{{$value->email}}</h4>
                  <small>{{str_limit($value->message,100) }} </small>
                  </a>
                </li>
             @endforeach
              </ul>
