...
<html lang="en">
    <head>
        ...
        <link href="{{asset('/panel/css/jasny-bootstrap.min.css')}}" rel="stylesheet"/>
                ...
                <div class="modal fade" tabindex="-1" role="dialog" id="upgradeModal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a type="button" href="#" class="btn btn-default"  data-dismiss="modal">الغاء</a>
                                <a type="button" class="btn btn-danger" id="complete_vip">تأكيد</a>
                            </div>
                        </div>
                    </div>
                </div>
...
$('body').on('click','.upgrade',function (e) {
    ...
    $('#complete_vip').attr('href', $(this).attr('href'));
});
