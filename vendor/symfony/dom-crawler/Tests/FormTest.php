...
class FormTest extends \PHPUnit_Framework_TestCase
{
        ...
        return array(
            ...
            array(
                ...
                '<input type="file" name="foo" />
                 <input type="submit" />',
                 array('foo' => array('FileFormField', array('name' => '', 'type' => '', 'tmp_name' => '', 'errors' => 4, 'size' => 0))),
            ),
        );
    }
    ...
    public function testGetFiles()
    {
        ...
        $this->assertEquals(array('foo[bar]' => array('name' => '', 'type' => '', 'tmp_name' => '', 'errors' => 4, 'size' => 0)), $form->getFiles(), '->getFiles() only returns file fields for POST');
        ...
        $this->assertEquals(array('foo[bar]' => array('name' => '', 'type' => '', 'tmp_name' => '', 'errors' => 4, 'size' => 0)), $form->getFiles(), '->getFiles() only returns file fields for PUT');
        ...
        $this->assertEquals(array('foo[bar]' => array('name' => '', 'type' => '', 'tmp_name' => '', 'errors' => 4, 'size' => 0)), $form->getFiles(), '->getFiles() only returns file fields for DELETE');
        ...
        $this->assertEquals(array('foo[bar]' => array('name' => '', 'type' => '', 'tmp_name' => '', 'errors' => 4, 'size' => 0)), $form->getFiles(), '->getFiles() only returns file fields for PATCH');
    ...
    {
        $form = $this->createForm('<form method="post"><input type="file" name="foo[bar]" /><input type="text" name="bar" value="bar" /><input type="submit" /></form>');
        $this->assertEquals(array('foo' => array('bar' => array('name' => '', 'type' => '', 'tmp_name' => '', 'errors' => 4, 'size' => 0))), $form->getPhpFiles(), '->getPhpFiles() converts keys with [] to arrays');
        ...
        $this->assertEquals(array('f.o o' => array('bar' => array('name' => '', 'type' => '', 'tmp_name' => '', 'errors' => 4, 'size' => 0))), $form->getPhpFiles(), '->getPhpFiles() preserves periods and spaces in names');
        ...
        $this->assertEquals(array('f.o o' => array('bar' => array('ba.z' => array('name' => '', 'type' => '', 'tmp_name' => '', 'errors' => 4, 'size' => 0), array('name' => '', 'type' => '', 'tmp_name' => '', 'errors' => 4, 'size' => 0)))), $form->getPhpFiles(), '->getPhpFiles() preserves periods and spaces in names recursively');
    }
